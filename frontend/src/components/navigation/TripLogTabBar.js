...
const HIDDEN_ROUTES = ['RegionDetail', 'History', 'Detail', 'BadgeList', 'ProfileEdit', 'RegionCollection', 'Notification', 'TravelLog', 'VerifyHistory', 'Wishlist', 'Appellation', 'EventList', 'EventDetail', 'ActivityHistory', 'NotificationSettings', 'LegalDocument', 'Withdraw'];
